        ...
        <div className="flex items-center justify-between h-16 md:h-20 !my-[12px]">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <a
              ...
              <span className="!text-base">{siteContent.business.phone}</span>
            </a>
            <a
              ...
              <span className="!text-base">{siteContent.business.email}</span>
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="hover:bg-[#ea580c] transition-all duration-300 hover:shadow-lg hover:scale-105 font-medium px-5 py-2 rounded-full text-white !bg-[#1454DA]">Get Quote
